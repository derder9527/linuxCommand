...
then
  ...
  echo  "\n\n\n" >>../$folder/README.md
  echo "![$practiceName](https://raw.githubusercontent.com/derder9527/linuxCommand/master/$folder/$practiceName"_demo.gif")">>../$folder/README.md
  echo  "\n\n\n" >>../$folder/README.md
  echo "[Source code at GitHub](https://github.com/derder9527/linuxCommand/tree/master/$folder)">>../$folder/README.md
  echo "README.md 建立成功"
else
